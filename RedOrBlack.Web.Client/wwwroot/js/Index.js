...
window.signTransaction = async function(fromAddress,contractAddress, tranData, value, gas, rtnFunction){
    ...
    const tx = {
        ...
        to: contractAddress,
        data: tranData,
        value: value, // It's better to specify the value in hexadecimal format
        gas: gas, // Also in hexadecimal, equivalent to 15,000,000 gas
